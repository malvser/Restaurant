...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/statistic/viewed_advertisement").hasRole("ADMIN")
                .antMatchers("/statistic/cooked_order").hasRole("ADMIN")
                .antMatchers("/statistic/no_advertisement").hasRole("ADMIN")
